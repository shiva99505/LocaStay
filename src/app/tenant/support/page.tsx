  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-base font-bold">
            <MessageSquare className="h-4 w-4 text-primary-600" /> Your Tickets ({tickets.length})
          </CardTitle>
        </CardHeader>
                  ...
                  <div key={ticket.id} className="px-5 py-4 hover:bg-muted/20 cursor-pointer">
                    <div className="flex items-start justify-between gap-2">
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-xs text-muted-foreground">{ticket.category} · #{ticket.id.slice(0, 8)} · {formatDate(ticket.createdAt)}</p>
                        {ticket.messages[0] && (
