        ...
        <div className="space-y-4">
          <div className="rounded-3xl border border-border bg-card p-6">
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              ...
              <div className="rounded-2xl bg-muted p-4">
                ...
                <p className="mt-1 text-lg font-semibold text-foreground">{formatDate(property.available_from ?? new Date())}</p>
              </div>
            </div>
          </div>
          ...
          <BookPropertyForm
            property={{
              ...
              availableFrom: property.available_from ? formatDate(property.available_from) : null,
            }}
          />
        </div>
