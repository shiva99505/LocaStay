                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      !notif.is_read && 'bg-primary-50/40 dark:bg-primary-500/5',
                    )}
                  >
                    <div className="relative flex-shrink-0 pt-1">
                      <div className={cn('h-2.5 w-2.5 rounded-full', notif.is_read ? 'bg-transparent' : 'bg-primary-600 dark:bg-primary-400')} />
                    </div>
