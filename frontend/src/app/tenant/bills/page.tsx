              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-border">
                  {(bills ?? []).map((bill) => {
                    ...
                    return (
                      <tr key={bill.id} className={cn('hover:bg-muted/20', isUnpaid && bill.due_date < new Date().toISOString() && 'bg-red-50/30 dark:bg-red-500/5')}>
                        ...
                        <td className="px-4 py-3 text-muted-foreground">{bill.paid_date ? formatDate(bill.paid_date) : '—'}</td>
                        <td className="px-4 py-3">
