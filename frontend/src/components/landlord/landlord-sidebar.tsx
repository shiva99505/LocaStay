...
export function LandlordSidebar({ user, unreadCount }: { user: SidebarUser; unreadCount: number }) {
  return (
...
export function LandlordMobileNav({ user, unreadCount }: { user: SidebarUser; unreadCount: number }) {
